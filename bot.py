# bot.py
# Full Club Auction Bot (Final Ultimate Build - Banter & Emojis Fixed)
...
# Hardcoded IDs added for flavor as requested
BATTLE_BANTER = [
...
# Battle Specific Emojis (Mixed IDs and Aliases)
...
def resolve_emoji(item):
    ...
    # 1. If Integer ID or String Digit -> Fetch Emoji Object
    ...
    if isinstance(item, str) and item.startswith(":") and item.endswith(":"):
        ...
        if e: return str(e)
        return item # If not found, return as text (e.g., standard emoji)
