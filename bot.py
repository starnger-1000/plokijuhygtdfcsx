# bot.py
# Full Club Auction & Pokémon Shop Bot (Certified Final Production Build v3.4 - Fixed Background Task)
...
class HelpView(discord.ui.View):
    ...
    async def updates_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        desc = (f"{E_STARS} **Latest Updates**\n{E_GOLD_TICK} **Full Shop System:** User Listings (via p!info), Admin Management.\n{E_GOLD_TICK} **New Commands:** `.usa` (List Item), `.usr` (Remove), `.daily`.\n{E_GOLD_TICK} **Human Numbers:** Support for `k`, `m`, `b`.\n{E_GOLD_TICK} **Secure Market:** Approvals for Club Buys.\n{E_GOLD_TICK} **Adv. Giveaways:** Images & Auto-tipping.")
