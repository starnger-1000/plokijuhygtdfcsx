...
# PART 1: Imports, Config, Assets, Database, and Helpers
...
def log_past_entity(user_id, type, name):
    if db is not None: past_entities_col.insert_one({"user_id": str(user_id), "type": type, "name": name, "timestamp": datetime.now()})
