# bot.py
# Full Club Auction Bot (Stable Production Build)
...
if MONGO_URL:
    try:
        # certifi.where() fixes the SSL error
    ...
    print("⚠️ MONGO_URL missing. Database features will fail.")
...
if db is not None:
    ...
    # Prevent immediate crash if DB is down, but commands will error
    clubs_col = None
...
def get_prefix(bot, message):
    # Fail-safe prefix if DB is down to prevent startup crash
