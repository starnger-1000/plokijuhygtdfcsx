# bot.py
# Full Club Auction & Pokémon Shop Bot (Certified Final Production Build v4.1)
# Part 1 of 2 - Core, Economy & Market
...
LOG_CHANNELS = {
    ...
    "shop_log": 1446017729340379246, # Sold items log
...
async def retireduelist(ctx, member: discord.Member = None):
    ...
    await send_log("duelist", create_embed(f"{E_DANGER} Retired", f"Duelist **{d['username']}** (ID: {d['id']}) retired.", 0xff0000))
...
async def user_shop_add(ctx, price: int, category: str):
    ...
    try:
        ...
        shop_items_col.insert_one({
            ...
            "seller_id": str(ctx.author.id), "is_shiny": False, "image_url": image_url, "sold": False, "timestamp": datetime.now(),
            "category": cat
        })
...
class HelpView(discord.ui.View):
    ...
    async def updates_btn(self, interaction: discord.Interaction, button: discord.ui.Button):
        desc = (f"{E_STARS} **Latest Updates**\n{E_GOLD_TICK} **Interactive Shop:** Categories (Shiny/Rare...).\n{E_GOLD_TICK} **Daily:** 100 Msgs in #chat.\n{E_GOLD_TICK} **Listings:** Added Category support.\n{E_GOLD_TICK} **Market:** Admin Approval Active.")
